  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <section className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <a href="mailto:hellofromusama@gmail.com" className="text-blue-600 hover:underline">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">+61 433695387</p>
              </div>
            </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex space-x-4">
              ...
              <a 
                href="https://crgtyokt.manus.space/" 
                target="_blank" 
                rel="noopener noreferrer"
        ...
        <section className="bg-white rounded-lg shadow-md p-8">
          <h2 className="text-2xl font-bold mb-6 border-b pb-2">Send Me a Message</h2>
          ...
          <div className="space-y-4">
            ...
            <div>
              <a
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-md transition-colors inline-block text-center"
              >
                Send Message
              </a>
              <p className="text-sm text-gray-500 mt-2">
                Note: This will open your default email client. Please copy your message there.
              </p>
            </div>
          </div>
        </section>
