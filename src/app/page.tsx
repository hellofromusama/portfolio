...
export default function Home() {
  ...
  const projects = [
    {
      ...
      description: "Humanitarian donation platform supporting relief efforts in Azad Kashmir with Stripe integration, transparent fund tracking, and beautiful Chinar leaf animations representing Kashmir's heritage",
      tech: ["Next.js 15", "React 19", "Stripe", "Tailwind CSS v4"],
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
      ...
      <section className={`relative z-10 pt-20 pb-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
